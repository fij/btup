...
3. Activate the installed conda environment with
     conda activate fin_course_env

4. At the anaconda prompt set up nbextensions (including toc) with 
     jupyter contrib nbextension install --user
   
5. Download the course files from this github repository to your computer
     download all files as a single zip file or git clone the repo
